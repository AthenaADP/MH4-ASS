...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lblHunterType->TabIndex = 27;
			...
			this->cmbHunterType->TabIndex = 26;
			...
			this->lblThunderRes->TabIndex = 16;
