...
#pragma endregion
	...
	public ref class Form1 : public System::Windows::Forms::Form
	{
		...
		Query^ query;
		Find^ find_dialog;
		Advanced::Result_t^ blast_options;
		Advanced::Result_t^ glast_options;
...
#pragma region Members
	...
	private: System::Windows::Forms::ToolStripMenuItem^  mnuAllowExcavated;
...
#pragma endregion
	...
	public:
		...
		void LoadConfig( String^ file, const bool lang )
		{
			...
			if( IO::File::Exists( file ) )
			{
				...
				else
				{
					...
					if( version >= 4 )
					{
						mnuAllowExcavated->Checked = Convert::ToBoolean( fin.ReadLine() );
		...
		void SaveConfig( String^ file )
		{
			...
			fout.WriteLine( mnuAllowExcavated->Checked );
			...
			for each( Solution^ solution in all_solutions )
			{
				...
				for( unsigned i = 0; i < 5; ++i )
				{
					fout.Write( Convert::ToString( solution->armors[ i ]->index ) );
					fout.Write( L" " );
				}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->mnuAllowExcavated = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->nudElder->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {7, 0, 0, 0});
			...
			this->nudElder->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {7, 0, 0, 0});
			...
			this->lblHR->Size = System::Drawing::Size(88, 13);
			this->lblHR->TabIndex = 6;
			this->lblHR->Text = L"Guild Hall Quests";
			// 
			// grpBSkills
			// 
			...
			this->txtSolutions->Size = System::Drawing::Size(332, 427);
			...
			this->groupBox4->Location = System::Drawing::Point(12, 416);
			...
			this->grpResults->Size = System::Drawing::Size(344, 453);
			...
			// mnuOptions
			// 
			this->mnuOptions->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(13) {this->mnuClearSettings, 
				this->toolStripSeparator1, this->mnuAllowBadSkills, this->mnuAllowArena, this->mnuAllowEventArmor, this->mnuAllowExcavated, this->mnuAllowJapaneseOnlyDLC, 
				this->mnuAllowLowerTierArmor, this->toolStripSeparator2, this->mnuMaxResults, this->mnuPrintDecoNames, this->mnuSortSkillsAlphabetically, 
				this->mnuSpendSpareSlots});
			...
			// mnuAllowExcavated
			// 
			this->mnuAllowExcavated->Checked = true;
			this->mnuAllowExcavated->CheckOnClick = true;
			this->mnuAllowExcavated->CheckState = System::Windows::Forms::CheckState::Checked;
			this->mnuAllowExcavated->Name = L"mnuAllowExcavated";
			this->mnuAllowExcavated->Size = System::Drawing::Size(238, 22);
			this->mnuAllowExcavated->Text = L"Allow E&xcavation Gear";
			// 
			...
			// mnuHelp
			// 
			this->mnuHelp->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {this->mnuSkillHelp, 
				this->mnuCheckForUpdates, this->mnuAbout});
			...
			this->tabHunterType->Size = System::Drawing::Size(355, 220);
			...
			this->tabBlademaster->Size = System::Drawing::Size(347, 194);
			...
			this->tabGunner->Size = System::Drawing::Size(347, 194);
			...
			this->ClientSize = System::Drawing::Size(729, 485);
			...
			this->Name = L"Form1";
			this->Text = L"Athena\'s ASS for MH4";
...
private: 
	System::Void FormulateQuery( const bool danger, const bool use_gunner_skills )
	{
		...
		query->allow_excavated = mnuAllowExcavated->Checked;
	...
	System::Void cmbSkill_SelectedIndexChanged( System::Object^ sender, List_t< ComboBox^ >% skills, List_t< ComboBox^ >% skill_filters, List_t< IndexMap^ >% index_maps )
	{
		...
		for( int i = 0; i < NumSkills; ++i )
		{
			...
			for( int j = 0; j < NumSkills; ++j )
				if( j != i && skills[ j ]->SelectedIndex > 0 )
...
#undef UpdateMenu
	...
	System::Void contextMenuStrip1_Opening( System::Object^ sender, System::ComponentModel::CancelEventArgs^ e )
	{
		...
		for( int i = 0; i < result_offsets.Count; ++i )
		{
			...
			if( line >= offset &&
				line < offset + 5 )
			{
				Utility::UpdateContextMenu( cmsSolutions, final_solutions[ i ]->armors[ line - offset ] );
				e->Cancel = false;
				return;
			}
		}
		...
		//check for extra skills
		{
			...
			else //check potential extra skills
			{
				...
				if( i >= 0 )
				{
					...
					String^ skillname = str->Substring( prefix, str->Length - prefix - suffix );
	...
	{
		System::Diagnostics::Process::Start( "http://forums.minegarde.com/topic/7170-athenas-armor-set-search-mh4/" );
	}
	...
	System::Void mnuSkillHelp_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		help_window = gcnew SkillHelp( -1, sender == mnuSkillHelp, mnuSortSkillsAlphabetically->Checked );
